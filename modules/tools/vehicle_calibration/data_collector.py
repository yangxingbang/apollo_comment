...
class DataCollector(object):
    ...
    def run(self, cmd):
        ...
        # map把字符串列表转化为float列表，并返回了列表的迭代器
        # list利用迭代器把list还原了
        # 所以self.cmd是一个list，其中的元素是float
        # self.cmd中可以有三个命令
