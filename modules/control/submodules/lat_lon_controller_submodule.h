...
namespace apollo {
namespace control {
// 这个模块本身就是一个单独的component
// Preprocessor是一个proto消息，包括header, local_view, engage_advice
// input_debug, received_pad_msg, estop, estop_reason这些内容
class LatLonControllerSubmodule final : public cyber::Component<Preprocessor> {
 ...
 private:
  // Component里的ProduceControlCommand只有一个形参ControlCommand
