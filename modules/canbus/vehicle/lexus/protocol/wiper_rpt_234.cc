...
void Wiperrpt234::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_enabled(
  ...
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_output_value(
      output_value(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_commanded_value(
      commanded_value(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_manual_input(
